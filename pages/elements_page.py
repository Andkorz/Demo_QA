...
class WebTablePage(BasePage):
    ...
    def check_deleted_person(self):
        return self.element_is_present(self.locators.N0_ROWS_FOUND).text
...
class ButtonsPage(BasePage):
    ...
    def click_on_different_button(self, type_click):
        if type_click == "double":
            ...
            self.scroll_to_element(double_button)
        ...
        if type_click == "contex":
            self.action_contex_click(self.element_is_visible(self.locators.CONTEXT_CLICK_BUTTON))
            return self.check_clicked_on_the_button(self.locators.SUCCESS_RIGHT)
        if type_click == "click":
            self.action_click(self.element_is_visible(self.locators.CLICK_ME_BUTTON))
...
class LinksPage(BasePage):
    ...
    def check_new_tab_simple_link(self):
        simple_link = self.elements_are_visible(self.locators.SIMPLE_LINK)[0]
...
class UploadAndDownloadPage(BasePage):
    ...
    def test_download_file(self):
        ...
        path_name_file = rf"C:\Users\user\PycharmProjects\Demo_QA\filetest{random.randint(0, 999)}.jpeg"
